...
class ExtReq:
  ...
  thrift_spec = (
    ...
    None, # 253
    None, # 254
    (255, TType.STRING, 'caller', None, None, ), # 255
  )
...
class Knowledge:
  ...
  thrift_spec = (
    ...
    (3, TType.STRING, 'object', None, None, ), # 3
  )
  ...
  def validate(self):
    ...
    if self.relation is None:
      raise TProtocol.TProtocolException(message='Required field relation is unset!')
...
class ExtRsp:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRING, 'text', None, None, ), # 1
    (2, TType.LIST, 'kn', (TType.STRUCT,(Knowledge, Knowledge.thrift_spec)), None, ), # 2
    None, # 3
    None, # 4
    None, # 5
    None, # 6
    ...
    None, # 253
    None, # 254
    (255, TType.STRING, 'server_info', None, None, ), # 255
  )
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.server_info = iprot.readString();
        else:
          iprot.skip(ftype)
      else:
        iprot.skip(ftype)
  ...
  def write(self, oprot):
    ...
    if self.server_info is not None:
      ...
      oprot.writeString(self.server_info)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
  ...
  def validate(self):
    if self.text is None:
      raise TProtocol.TProtocolException(message='Required field text is unset!')
    if self.kn is None:
      raise TProtocol.TProtocolException(message='Required field kn is unset!')
    if self.server_info is None:
      raise TProtocol.TProtocolException(message='Required field server_info is unset!')
    return
...
class BadCaseReq:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.LIST, 'badcases', (TType.STRUCT,(Knowledge, Knowledge.thrift_spec)), None, ), # 1
    None, # 2
    None, # 3
    None, # 4
    None, # 5
  ...
  def validate(self):
    if self.badcases is None:
      raise TProtocol.TProtocolException(message='Required field badcases is unset!')
    if self.caller is None:
      raise TProtocol.TProtocolException(message='Required field caller is unset!')
    return
...
class BadCaseRsp:
  ...
  def validate(self):
    if self.retcode is None:
      raise TProtocol.TProtocolException(message='Required field retcode is unset!')
    if self.server_info is None:
      raise TProtocol.TProtocolException(message='Required field server_info is unset!')
    return
